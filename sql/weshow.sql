...
-- ----------------------------
-- Table structure for w_show
-- ----------------------------
DROP TABLE IF EXISTS `w_show`;
CREATE TABLE `w_show` (
...
-- Records of w_user
-- ----------------------------
INSERT INTO `w_user` VALUES ('1', 'markerhub', 'https://image-1300566513.cos.ap-guangzhou.myqcloud.com/upload/images/5a9f48118166308daba8b6da7e466aab.jpg', null, '96e79218965eb72c92a549dd5a330112', '0', '2020-04-20 10:44:01', null);
